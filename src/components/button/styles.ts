...
export const buttonStyles: ButtonStyles = {
    ...
    // Interactive states
    states: {
        hover: 'hover:before:opacity-[0.08] hover:before:bg-current hover:before:absolute hover:before:inset-0',
        focus: 'focus-visible:before:opacity-[0.12] focus-visible:before:bg-current focus-visible:before:absolute focus-visible:before:inset-0 focus-visible:ring-2 focus-visible:ring-md-primary focus-visible:ring-offset-2',
        active: 'active:before:opacity-[0.12] active:before:bg-current active:before:absolute active:before:inset-0',
...
export const fabStyles: FABStyles = {
    ...
    variants: {
        ...
        secondary: 'bg-md-secondary-container text-md-on-secondary-container shadow-md-3 hover:shadow-md-4',
        tertiary: 'bg-md-tertiary-container text-md-on-tertiary-container shadow-md-3 hover:shadow-md-4',
    },
};
