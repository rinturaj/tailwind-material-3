...
export function createTransition(
    ...
    duration: keyof DurationTokens | string = 'short2',
    easing: keyof EasingTokens | string = 'standard'
): string {
    const props = Array.isArray(properties) ? properties : [properties];
    const durationValue = duration in durationTokens ? durationTokens[duration as keyof DurationTokens] : duration;
